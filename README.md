...
______________________________________________
 ### **Do you want a more exhilarating feeling when playing? Then welcome to one if not the largest modpack for modern Minecraft with 360 mods! This modpack is ran on Fabric for better optimization of its ark full of many mods to work to deliver a better experience while playing.**
______________________________________________
> #### **Serenity's Edge is a large modpack inspired by LifeInTheWoods that aims to deliver a more realistic, serene and exciting experience through its many immersive mods. SE is a modpack based on technology, item processing exploration & adventuring!**
> #### **Explore a beautifully landscaped world generated primarily by William Whythers and OhTheBiomesYou'llGo generation and venture out to see what the Serenity experience has to offer but be wary of what may lie on the edge...**

![](https://i.imgur.com/8qWS2OS.png)
_______________________
> ### **360 Mods Featuring:**

#### - **William Wythers x BYG World Generation, Traverse, Promenade & More!**


#### - **Structure Mods Including ChoiceTheorem's Overhauled Villages & Keebsz's BattleTowers**


#### - **New & Enhanced Dimensions with BetterNether x BetterEnd, Incendium, Endscape, Nullscape , Eden Ring, Deeper&Darker and now the TwilightForrest!**

#### - **New Enthralling Mobs from BetterAnimalsPlus, Mobz, AdventureZ, Voidz, & The Graveyard & more!**


#### - **Automation w/TechReborn & Industrial Revolution, DarkUtilities & Modern Dynamics**


#### - **Fun & Customizable Movement Mechanics from Advanced Movement & Combat Roll**


#### - **Time & Wind x Sleepwarp (For cycle length & realistic sleep)**
...
#### **Iris x Sodium x Indium, Lithium, Krypton, Starlight x Spark & LambsDynamicLights + culling mods**
...
#### **It's recommended that at least 8 gigabytes of ram are allocated as this pack has lots lots of mods. You may be able to get away with just 6 but expect slow load times.**

#### + **Yes, both EMI and JEI are installed. Why? Space Dimension & TwilightForrest highly recommend JEI while EMI is slightly more configurable, has recipe trees and shows more information for fabric mods.**

#### - **JEI will use its normal config for hotkeys.**
 
#### - **For EMI you can set all hotkeys via the modmenu config. (Some keys have already been changed to avoid conflict with JEI)**

#### **The client will take some time to load and may seem like its timing out, don't worry this is normal just let it do its thing.**
_______________________
###  **[NOTE!]**:

> ### * **If you are experiencing crashes on Technic change you Java profile from Oracle to OpenJDK. You can find this via: Launcher Options> Java Settings.**
> ### * **Remember to make a backup of any old worlds with Serenity's Edge when updating. If you're client crashes on first run, just load it again.**
>  ### * **If you are trying to load a Resourcepack I suggest putting it your Resourcepacks folder via the [Paxi](https://www.curseforge.com/minecraft/mc-mods/paxi-fabric) config folder. This will allow for loading of the pack(s) on start up and will skip slow pack loading.**
_______________________
**Future Plans:**
